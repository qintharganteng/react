...
<div className="bg-black overflow-hidden whitespace-nowrap">
  ...
  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ •  MANISH BY ZULFIMANHAJ 
  </div>
</div>
      ...
      <div className="flex justify-between items-center px-6 py-4 border-b">
        <div className="text-xl font-bold tracking-widest">OUR WEBSITE STORE</div>
      ...
      <div
        className={`md:hidden fixed top-0 left-0 w-3/4 h-full bg-white z-40 p-6 transform duration-300 ${
         ...
         >
        <h2 className="text-2xl font-poppins text-[#00df9a] mb-6">OUR WEBSITE STORE</h2>
